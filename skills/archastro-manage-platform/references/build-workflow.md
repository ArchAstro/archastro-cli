...
If the workflow needs script logic, author and validate that script first. Route to the [build-script guide](build-script.md) for detailed script authoring guidance, or get the reference directly:
```
