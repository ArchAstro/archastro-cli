...
7. **On success**, tell the user the CLI is ready and {{#CLAUDE_COMMAND}}suggest `/archastro:auth`{{/CLAUDE_COMMAND}}{{#SKILL}}suggest they run `archastro auth login` to authenticate{{/SKILL}}.
