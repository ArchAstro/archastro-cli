---
name: operate-agents
description: Inspect and operate deployed ArchAstro agents. Use for agent health, failed or waiting runs, tools, computers, working memory, activity, manual reviews, and notifications.
